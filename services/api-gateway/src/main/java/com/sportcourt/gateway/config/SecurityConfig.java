    ...
    SecurityWebFilterChain securityWebFilterChain(ServerHttpSecurity http) {
        return http
            ...
            .authorizeExchange(exchanges -> exchanges
                ...
                .permitAll()
                .pathMatchers(HttpMethod.GET, "/api/auth/oauth2/google", "/oauth2/**", "/login/oauth2/**")
                .permitAll()
                ...
                .pathMatchers(HttpMethod.GET, "/api/payments/vnpay/ipn", "/api/payments/vnpay/return").permitAll()
                ...
                .hasAnyRole("CUSTOMER", "OWNER", "ADMIN")
                .pathMatchers(HttpMethod.POST, "/api/payments/vnpay/create-payment")
                .hasAnyRole("CUSTOMER", "OWNER", "ADMIN")
