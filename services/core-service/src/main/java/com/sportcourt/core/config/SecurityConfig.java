    ...
    SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .permitAll()
                .requestMatchers(HttpMethod.GET, "/api/core/pricing/**", "/api/core/pricing-rules/**")
                .permitAll()
                .requestMatchers(HttpMethod.GET, "/api/core/products/**")
                .permitAll()
